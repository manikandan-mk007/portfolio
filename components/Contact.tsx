        ...
        <div className="contact-wrap">
          <div className="contact-info reveal">
            <p className="contact-intro">
              ...
              Whether you have a project in mind or just want to chat about full-stack
            ...
            <div className="social-links">
              <a
                href="https://github.com/manikandan-mk007"
              ...
              <a
                href="https://www.linkedin.com/in/thangamanikandan-i-560b20396/"
                className="social-link"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://leetcode.com/u/SxdrFzxYeB/"
                className="social-link"
                target="_blank"
                rel="noopener noreferrer"
              >
                ...
                >
                  <path
                    d="M16.102 17.93L9.6 11.4l6.5-6.5"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                className={`form-input form-textarea ${errors.message ? "error" : ""} ${
                  formData.message && !errors.message ? "success" : ""
                }`}
            ...
            {status && (
              <div
                className={`form-success ${
                  status.includes("sent") || status.includes("Message sent") ? "visible" : ""
                }`}
              >
                {status}
              </div>
