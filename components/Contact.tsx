          ...
          <div className="contact-info reveal">
            ...
            <ul className="contact-details">
              ...
              <li>
                ...
                <span>Dindigul, Tamil Nadu (Remote OK)</span>
              </li>
            </ul>

            <div className="social-links">
              <a href="https://github.com/YOUR_USERNAME" className="social-link" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://linkedin.com/in/YOUR_USERNAME" className="social-link" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                  fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://twitter.com/YOUR_USERNAME" className="social-link" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                  fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
